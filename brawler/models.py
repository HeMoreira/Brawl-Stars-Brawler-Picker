...
# from proficiencies.models import Proficiency
...
class Brawler(models.Model):
    ...
    # base_proficiency = models.ForeignKey(Proficiency, on_delete=models.PROTECT, verbose_name="Base Proficiency", default=)
    # first_gadget
    # second_gadget
    # first_star_power
    # second_star_power
