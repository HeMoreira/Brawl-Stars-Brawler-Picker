...
class Proficiency(models.Model):
    ...
    _average_projectiles_per_shot = models.SmallIntegerField(verbose_name="Average Projectiles per Shot", help_text="Average number of projectiles fired in each shot", default=0)
    _projectiles_per_shot_in_short_range = models.SmallIntegerField(verbose_name="Projectiles per Shot in Short Range", help_text="Average number of projectiles fired in each shot when the enemy is close", default=0)
    _projectiles_per_shot_in_medium_range = models.SmallIntegerField(verbose_name="Projectiles per Shot in Medium Range", help_text="Average number of projectiles fired in each shot when the enemy is at medium distance", default=0)
    _projectiles_per_shot_in_long_range = models.SmallIntegerField(verbose_name="Projectiles per Shot in Long Range", help_text="Average number of projectiles fired in each shot when the enemy is far", default=0)
    _projectiles_per_shot_in_very_long_range = models.SmallIntegerField(verbose_name="Projectiles per Shot in Very Long Range", help_text="Average number of projectiles fired in each shot when the enemy is very far", default=0)
    _shotting_time = models.SmallIntegerField(verbose_name="Reshotting Time", help_text="Time necessary to be able to shoot again", default=0)
    ...
    _super_time = models.SmallIntegerField(verbose_name="Resuper Time", help_text="Time necessary to be able to super again", default=0)
    ...
    _durability = models.SmallIntegerField(verbose_name="Durability", help_text="Capacity of absorving damage", default=0)
    _attack_distance = models.SmallIntegerField(verbose_name="Attack-Distance", help_text="Capacity of attack from long distances", default=0)
    ...
    _surprise_attack = models.SmallIntegerField(verbose_name="Surprise-Attack", help_text="Capacity of rushing enemies quickly (frequency, (surprise-attack-distance, velocity))", default=0)
