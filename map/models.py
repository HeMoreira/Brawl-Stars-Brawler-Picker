...
class Map(models.Model):
    ...
    proficiency_multiplier = models.OneToOneField(Proficiency, on_delete=models.CASCADE, verbose_name="Proficiency Multiplier", help_text="The proficiencies of brawlers and others are multiplied from this map proficiencies, so use 10 by default and rarely use numbers above 25. All numbers here are divided by ten before being used as a multiplier")
